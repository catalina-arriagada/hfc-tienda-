        ...
        <Header />
            <main className="main">
                <section className="welcome">
                    ...
                    <p className="welcome__txt"> Somos una tienda especializada en tinturas veganas color fantasía, y productos de estética capilar. También somos un Salón de Belleza especializado en coloración y cuidado capilar.</p>
                ...
                <section className="container-testimonials">
                    ...
                    <p className="testimonials__txt">¡Me encantan las tinturas de Hair Fashion Colors! El "Rojo" me vino de maravilla, y le dí un toque más rosa para que combinara con mi pelo. Y nos queda el verde, celeste, negro y morado. Mi estudio fotográfico Pedrito Marinello está muy contento con los resultados, 100% recomendado.</p>
                ...
                <section className="container-tips">
                    ...
                    <div className="box">
                        <div className="box__icon"><i className="fas fa-cog"></i></div>
                        <div className="box__content">
                        <h3 className="box__title">CORTES Y PEINADOS</h3>
                        <p className="box__txt">Cortes de mujer, hombre, niño (hasta 10 años), Corte chasquilla/flequillo, Brushing, alisados, etc.</p>
                        </div>
                    </div>
                    <div className="box">
                        <div className="box__icon"><i className="fas fa-university"></i></div>
                        <div className="box__content">
                        <h3 className="box__title">COLORACIONES</h3>
                        <p className="box__txt">Retoques, pigmentaciones, decoloraciones, despigmentación, iluminación, etc. </p>
                        </div>
                    </div>
                    <div className="box">
                        <div className="box__icon"><i className="fas fa-wrench"></i></div>
                        <div className="box__content">
                        <h3 className="box__title">REPARACIÓN CAPILAR</h3>
                        <p className="box__txt">Anti-frizz, moldeados, lavados, Olaplex, Botox capilar, etc.</p>
                        </div>
                    </div>
                    </div>
                </section>
